...
\begin{proof}
	\begin{enumerate}
	\item Se para algum $n \in \N$ vale $\med(M_n) = \infty$, então ambos lados da equação serão $\infty$. Resta provar a equação para o caso em que, para todo $n \in \N$, $\med(M_n) < \infty$. Definamos $M'_0 := M_0$ e, para todo $n \in \N \setminus \{0\}$,
		\begin{equation*}
