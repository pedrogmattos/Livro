...
\begin{proposition}
\label{prop:prorpiedades.imediatas.medida}
...
Sejam $(X, \mens,\med)$ um espaço de medida e $(M_n)_{n \in \N}$ uma sequência de conjuntos mensuráveis.
	...
	\item Se $(M_n)_{n \in \N}$ é crescente, então
		...
		\end{equation*}
	\item Se $(M_n)_{n \in \N}$ é decrescente e, para algum $n_0 \in \N$ vale $\med(M_{n_0}) < + \infty$, então
		\begin{equation*}
...
\begin{proof}
	\begin{enumerate}
	\item Se para algum $n \in \N$ vale $\med(M_n) = \infty$, então ambos lados da equação serão $\infty$. Resta provar a esquação para o caso em que, para todo $n \in \N$, $\med(M_n) < \infty$. Definamos $M'_0 := M_0$ e, para todo $n \in \N \setminus \{0\}$,
		\begin{equation*}
		M'_n := M_n \setminus M_{n-1}.
		\end{equation*}
	A sequência $(M'_n)_{n \in \N}$ é disjunta aos pares, pois $(M_n)_{n \in \N}$ é crescente, e vale
		\begin{equation*}
		\bigcup_{n \in \N} M'_n = \bigcup_{n \in \N} M_n.
		\end{equation*}
	Assim, segue da $\sigma$-aditividade de $m$ que
		\begin{align*}
		\med\left(\bigcup_{n \in \N} M_n\right) &= \med\left(\bigcup_{n \in \N} M'_n\right) = \sum_{n \in \N} \med(M'_n) = \lim_{n \to \infty} \sum_{n'=0}^{n} \med(M'_{n'}).
		\end{align*}
	Pela proposição~\ref{prop:prorpiedades.imediatas.medida}, segue que $\med(M'_{n'}) = \med(M_{n'}) - \med(M_{n'-1})$, pois $\med(M_{n'}) < \infty$, portanto
		\begin{equation*}
		\sum_{n' = 0}^{n} \med(M'_{n'}) = \sum_{n'=0}^{n} \left( \med(M_{n'}) - \med(M_{n'-1}) \right) = \med(M_n),
		\end{equation*}
	logo
		\begin{equation*}
		\med\left(\bigcup_{n \in \N} M_n\right) = \lim_{n \to \infty}  \med(M_n).
	...
	\item Seja $n_0 \in \N$ tal que $\med(M_{n_0}) < + \infty$ e definamos, para todo $n \in \N$, $M'_n := M_{n_0} \setminus M_n$. Isso implica que para $n < n_0$ vale $M'_n = \emptyset$ e que a sequência $(M'_n)_{n \in \N}$ é crescente, portanto segue do item anterior que
		\begin{align*}
		\med\left( \bigcup_{n \in \N} M'_n \right) &= \lim_{n \to \infty} \med(M'_n) \\
			&= \lim_{n \to \infty} (\med(M_{n_0}) - \med(M_n)) \\
			&= \med(M_{n_0}) - \lim_{n \to \infty} \med(M_n).
		\end{align*}
	Mas $\bigcup_{n \in \N} M'_n = M_{n_0} \setminus \left( \bigcap_{n \in \N} M_n \right)$, portanto
		\begin{equation*}
		\med\left( \bigcup_{n \in \N} M'_n \right) = \med(M_{n_0}) - \med\left( \bigcap_{n \in \N} M_n \right).
		\end{equation*}
...
Seja $\bm X$ um espaço de medida.
	\begin{enumerate}
	\item Os conjuntos $\set{M \in \mens}{M \qeq \emptyset}$ e $\set{M \in \mens}{M \qeq X}$ são fechados sob \allowbreak união e interseção enumeráveis;
...
\begin{proposition}
Sejam $\bm X$ um espaço de medida e $f$, $f' \in \Men(\bm X,\intff{0}{\infty})$ funções simples mensuráveis.
	\begin{enumerate}
...
\begin{definition}
Sejam $\bm X$ um espaço de medida e $f\in \Men(\bm X,\intff{0}{\infty})$ uma função simples mensurável.
