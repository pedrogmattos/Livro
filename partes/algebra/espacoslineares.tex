...
\subsubsection{2-Formas reais e os espaços \texorpdfstring{\ensuremath{\R^{p,q}}}{(p,q)-hiperbólicos reais}}
...
\begin{definition}
Sejam $\bm V$ um espaço linear sobre um corpo $\bm C$ e $k \in \N$. A \emph{potência tensorial de tipo $k$} (ou \emph{potência $k$-tensorial}) de $\bm V$ é o espaço
	\begin{equation*}
...
A \emph{potência tensorial de tipo $(k,k')$} (ou \emph{potência $(k,k')$-tensorial}) de $\bm V$ é o espaço
	\begin{equation*}
	V^{\otimes (k,k')} := (V\dual)^{\otimes k} \otimes V^{\otimes k'}.
	\end{equation*}
%	\begin{equation*}
%	V^{\otimes p*q} := V^{\otimes p} \otimes (V\dual)^{\otimes q}.
%	\end{equation*}
Um $(k,k')$-tensor de $\bm V$ é um elemento de $V^{\otimes (p,q)}$.

A \emph{álgebra tensorial} de $\bm V$ é o espaço
	\begin{equation*}
...
Temos as identificações
	\begin{align*}
	V^{\otimes (0,0)} &\simeq C \\
	V^{\otimes (1,0)} &\simeq V\dual \\
	V^{\otimes (0,1)} &\simeq V \\
	V^{\otimes (1,1)} &\simeq \lin(V,V). \\
