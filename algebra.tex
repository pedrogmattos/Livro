...
\end{prop}
\begin{proof}
Se existe ação $A: \bm G \age X$, basta definir $g \pt x \coloneqq A(g)(x)$ e segue que $e\pt = \id$ e $(g_1g_0) \pt = g_1 \pt \circ g_0 \pt$. Reciprocamente, definimos a ação $A$ a partir de $\pt$ da mesma forma e, se $g_0,g_1 \in G$ e $x \in X$, segue que
	\begin{equation*}
...
Sejam $X$ um conjunto, $\bm G$ um grupo, $\bm G \age X$ e $x \in X$. A \emph{órbita} de $x$ sob $\bm G$ é o conjunto
	\begin{equation*}
	G \pt x \coloneqq \set{g\pt x}{g \in G}.
	\end{equation*}
\end{defi}
...
Sejam $\bm C$ um corpo e $n \in \N$. O \emph{grupo linear especial} de $\bm C$ de ordem $n$ é o conjunto
	\begin{equation*}
	\SL_n(\bm C) \coloneqq \set{M \in \GL(n,\bm C)}{\det M =1}.
	\end{equation*}
\end{defi}
...
$(\C^m,i)$, sendo $i \cdot z\coloneqq (\sqrt{-1}z_1,\dots,\sqrt{-1}z_m)$.
